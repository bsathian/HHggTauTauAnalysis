...
transfer_input_files    = utils.py,cachepreload.py,analysisenv.tar.gz
...
class UCSDHTCondorJob(HTCondorJob):
    ...
    submit_command = "condor_submit -debug"#-queue 1 -debug"
...
def make_htcondor_cluster(
    ...
    input_files = ["utils.py","cachepreload.py","analysisenv.tar.gz"]
    #input_files = ["utils.py","cachepreload.py","daskworkerenv.tar.gz"]
    log_directory = "logs/"
    ...
    params = {
            ...
            "scheduler_options" : {"dashboard_address":":{}".format(dashboard_address)},
